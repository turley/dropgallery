...
//   Linux:   ~/.local/share/dropgallery/log/   (XDG_DATA_HOME)
//   Windows: %LOCALAPPDATA%/dropgallery/Log/
// `{ suffix: '' }` drops env-paths' default `-nodejs` suffix so the macOS
// path stays `Library/Logs/dropgallery` (matching the README + prior
// behavior) instead of `Library/Logs/dropgallery-nodejs`.
